    ...
    const tableActionItems = item => [
        {
            ...
            onClick: () =>
                history.push(
                    routes.promotionPage.path.replace(':id', item._id)
                )
        },
        {
            icon: 'delete',
            ...
            onClick: () =>
                ...
                promotionsApi.deletePromo(item._id, ({ data }) => {
                    if (data.success) getPromotions()
                })
        }
    ]
        ...
        <div className='mainPage'>
            <div className='mainPage__wrapper'>
                <div className='mainPage__header'>
                    <h3>Promotions</h3>
                    <Link to={routes.promotionPage.path.replace(':id', 'new')}>
